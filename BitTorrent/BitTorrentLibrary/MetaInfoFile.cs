...
namespace BitTorrentLibrary
{
    ...
    public class MetaInfoFile
    {
        ...
        private void Load()
        {
            ...
            {
                throw new BitTorrentError($"Could not find torrent file {TorrentFileName}");
            }
        ...
        public MetaInfoFile(string fileName)
        {
            ...
            {
                throw new BitTorrentError($"(MetaInfoFile) Error:" + ex.Message);
            }
        }
        /// <summary>
        ...
        internal ValueTuple<UInt64, List<FileDetails>> LocalFilesToDownloadList(string downloadPath)
        {
            ...
            {
                Log.Logger.Debug(ex);
                throw new BitTorrentError("(MetaInfoFile) Error: Failed to create download file list." + ex.Message);
            }
